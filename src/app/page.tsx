  ...
  return (
    <div className="font-sans min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        <div className="mb-8">
          <h2 className="text-6xl md:text-7xl font-bold text-transparent bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text mb-6">
            Welcome to Hat rean
          </h2>
          <p className="text-2xl text-gray-600 mb-4">The Ultimate Quiz Experience 🧠✨</p>
